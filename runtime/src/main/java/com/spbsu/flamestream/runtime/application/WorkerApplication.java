...
public final class WorkerApplication {
  ...
  public void run() {
    final Config config = ConfigFactory.parseString("akka.remote.artery.canonical.port=" + host.port())
            .withFallback(ConfigFactory.parseString("akka.remote.artery.canonical.hostname=" + host.host()))
